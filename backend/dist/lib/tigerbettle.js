...
const TB_ADDRESSES = (process.env.TB_ADDRESSES ?? process.env.TB_ADDRESS ?? "3000").split(",");
...
export function buildTbAccount(ledger = 1) {
    return {
        id: id(),
        debits_pending: 0n,
        debits_posted: 0n,
...
//# sourceMappingURL=tigerbettle.js.map